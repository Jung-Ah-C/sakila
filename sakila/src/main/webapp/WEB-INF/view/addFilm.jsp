                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
							      <form id="addForm" action="${pageContext.request.contextPath}/admin/addFilm" method="post">
							         ...
							         <div>
						                <input class="btn mb-1 btn-primary" id="addButton" type="button" value="영화 추가" />
						                <input class="btn mb-1 btn-primary" type="reset" value="초기화" />
						                <a class="btn mb-1 btn-primary" href="${pageContext.request.contextPath}/admin/getFilmList">영화 목록</a>
						          	 </div>
							      </form>
						      </div>
                            </div>
