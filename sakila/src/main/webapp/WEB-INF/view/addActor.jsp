                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <form id="addForm" action="${pageContext.request.contextPath}/admin/addActor" method="post">
	                                    ...
	                                    <div>
							                <input class="btn mb-1 btn-primary" id="addButton" type="button" value="배우 추가" />
							                <input class="btn mb-1 btn-primary" type="reset" value="초기화" /> 
							                <a class="btn mb-1 btn-primary" href="${pageContext.request.contextPath}/admin/getActorList">배우 목록</a>
							            </div>
                                    </form>
                                </div>
                            </div>
